...
import { type Button, buttonVariants } from "@suiss/ui/components/button"
import { cn } from "cn"
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex min-h-11 cursor-pointer select-none items-start gap-3 rounded-4xl border border-input px-4 py-3.5 text-start text-sm outline-none transition-colors hover:bg-input/40 has-[>input:focus-visible]:border-ring has-[>input:focus-visible]:ring-[3px] has-[>input:focus-visible]:ring-ring/50 data-checked:border-primary/40 data-invalid:border-destructive data-checked:bg-primary/10",
    ...
    >
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-5 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-full border border-input bg-background/80 font-medium font-mono text-[0.625rem] text-muted-foreground leading-none group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  )
}
